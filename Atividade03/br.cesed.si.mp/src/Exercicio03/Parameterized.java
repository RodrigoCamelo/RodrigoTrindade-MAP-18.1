...
class Parameterized {
	...
	private static class HB20 implements Car{
		public String showInfo() {
			return "HB20. Hatch from Hyunday";
		}
	}
	
	private static class Elantra implements Car{
		public String showInfo() {
			return "Elantra. Sedan from Hyunday";
		}
	}
	...
	public static void main(String[] args) {
		...
		Parameterized.CarFactory Hyunday = new Parameterized.Hyunday();
		...
		System.out.println("Hyunday factory creates " + Hyunday.createCar(Type.HATCH).showInfo());
		System.out.println("Hyunday factory creates " + Hyunday.createCar(Type.SEDAN).showInfo());
	}
}
